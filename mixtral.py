...
# ========== Config ==========
MODEL_NAME = os.path.expanduser("~/mixtral-8x7b")  # Change as needed (e.g., 'mistralai/Mistral-7B-Instruct-v0.2')
OUTPUT_DIR = os.path.expanduser("~/mixtral-lora-training-matrics")
...
response_template_ids = [7226, 11143, 28747, 13] # It was almost impossible for me to encode the write string that matches Assistant. I tried all the combintations with colon, with out colon, with nextline, but couldnt figure it out. then i back traced and picked the tokens for the Assistant by checkning the tokens of a prompt.
